<!DOCTYPE html>
<html lang="en" dir="" data-nav-layout="horizontal" data-nav-style="menu-hover" data-menu-position="fixed" data-theme-mode="light">
    ...
    <body class="landing-body">
		...
		<div class="landing-page-wrapper">
            ...
            <!-- HEADER -->
            <?php include 'layouts/components/marketplace/landing-header.php'; ?>

            <!-- END HEADER -->

            <!-- SIDEBAR -->
            <?php include 'layouts/components/marketplace/landing-sidebar.php'; ?>
