...
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-hover" data-menu-position="fixed" data-theme-mode="light">
    ...
    <head>
        ...
        <?php include 'layouts/components/realestate/styles.php'; ?>
    ...
    <body class="landing-body">
		...
		<div class="landing-page-wrapper">
            ...
            <!-- HEADER -->
            <?php include 'layouts/components/realestate/user-profile-header.php'; ?>

            <!-- END HEADER -->

            <!-- SIDEBAR -->
            <?php include 'layouts/components/realestate/user-profile-sidebar.php'; ?>
            ...
            <!-- FOOTER -->
            <?php include 'layouts/components/realestate/footer.php'; ?>
        ...
        <!-- SCRIPTS -->
        <?php include 'layouts/components/realestate/scripts.php'; ?>
