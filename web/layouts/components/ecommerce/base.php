...
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-hover" data-menu-position="fixed" data-theme-mode="light">
    ...
    <head>
        ...
        <?php include 'layouts/components/ecommerce/styles.php'; ?>
    ...
    <body class="landing-body ecommerce-landing">
		...
		<div class="landing-page-wrapper">
            ...
            <!-- SIDEBAR -->
            <?php include 'layouts/components/ecommerce/sidebar.php'; ?>

            <!-- END SIDEBAR -->

            <!-- OFFCANVAS -->
            <?php include 'layouts/components/ecommerce/offcanvas.php'; ?>
            ...
            <!-- FOOTER -->
            <?php include 'layouts/components/ecommerce/footer.php'; ?>
        ...
        <!-- SCRIPTS -->
        <?php include 'layouts/components/ecommerce/scripts.php'; ?>
