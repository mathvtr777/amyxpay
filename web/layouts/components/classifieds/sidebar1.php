                ...
                <div class="container p-0">
                    ...
                    <div class="main-sidebar">
                        ...
                        <nav class="main-menu-container nav nav-pills sub-open">
                            ...
                            <ul class="main-menu flex-fill">
                                <!-- Start::slide -->
                                <li class="slide">
                                    <a class="side-menu__item active" href="javascript:void(0);">
                                ...
                                <li class="slide">
                                    <a href="javascript:void(0);" class="side-menu__item">
                                        <span class="side-menu__label">All Ads</span>
                                    </a>
                                </li>
                                <!-- End::slide -->
                                <!-- Start::slide -->
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child1">
                                        ...
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">FAQ</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Services</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Add Details</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Add Post</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">404</a>
                                        </li>
                                        <li class="slide has-sub">
                                ...
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child1">
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Blog</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Blog Details</a>
                                        </li>
                                        <li class="slide">
                                            <a href="javascript:void(0);" class="side-menu__item">Blog Post</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- End::slide -->
                            ...
                            <div class="d-lg-flex d-none align-items-center">
                                <!-- Start::header-link -->
                                <a href="javascript:void(0);" class="me-3" data-bs-toggle="modal" data-bs-target="#searchModal">
                                ...
                                <div class="country-selector dropdown">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-wave btn-light border btn-country dropdown-toggle me-2" data-bs-toggle="dropdown">
                                        English
                                    </a>
                                    <!-- End::dropdown-toggle -->
                                    <ul class="main-header-dropdown dropdown-menu py-2" data-popper-placement="none">
                                        <li>
                                ...
                                <div class="btn-list d-xl-flex d-none">
                                    <a href="signin-basic.php" class="btn btn-wave btn-light border">
                                        Login / Register
                                    </a>
                                    <button class="btn btn-wave btn-primary">
                                        <i class="bi bi-plus-circle me-2"></i>Post Your Ad
                                    </button>
                                </div>
                            </div>    
                        </nav>
