...
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-hover" data-menu-position="fixed" data-theme-mode="light">
    ...
    <head>
        ...
        <?php include 'layouts/components/domain/styles.php'; ?>
    ...
    <body class="landing-body">
		...
		<div class="landing-page-wrapper">
            ...
            <!-- HEADER -->
            <?php include 'layouts/components/domain/landing-header.php'; ?>

            <!-- END HEADER -->

            <!-- SIDEBAR -->
            <?php include 'layouts/components/domain/landing-sidebar.php'; ?>
            ...
            <!-- FOOTER -->
            <?php include 'layouts/components/domain/footer.php'; ?>
        ...
        <!-- SCRIPTS -->
        <?php include 'layouts/components/domain/scripts.php'; ?>
