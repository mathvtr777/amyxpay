        ...
        <div class="d-flex align-items-center justify-content-center min-vh-100">
            <div class="text-center">
                ...
                <p class="text-muted fs-15 mb-4 max-w-lg mx-auto">
                    O sistema de Saques/Carteira (Retiradas) foi removido em favor do novo <strong>Pix Checkout Direto</strong>.
                    <br>Os pagamentos agora são processados diretamente pelos provedores configurados.
                </p>
